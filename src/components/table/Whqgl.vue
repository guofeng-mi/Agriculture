 ...
 * @LastEditTime : 2020-01-17 11:52:57
 -->
<template>
...
<!--            </template>-->
      ...
      <div class="right">
        ...
        <div class="bot_sub">
          <i-button type="success" @click="show = true">添加物候期</i-button>
        </div>
      </div>
    </div>
    ...
    <!-- 新增弹窗 -->
      <WhqglAdd v-if="show" @close="close"></WhqglAdd>
