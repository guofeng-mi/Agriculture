...
import 'echarts/map/js/world.js'; //引入中国数据地图
import 'echarts-gl'
...
export default {
  ...
  // var app = {}, option = null;
    ...
    myChart.setOption({
        ...
        series: [{
            ...
            data: this.convertData([
              {name: "沈阳", value: (Math.random() * 300).toFixed(2)},
    ...
    myChart.on('click', function (params) {
      ...
      that.$Modal.confirm({
          title: '提示',
          content: `<p>将要跳转到公司${1}</p><p>是否跳转？</p>`,
          okText: '跳转',
          cancelText: '取消',
          onOk: () => {
            console.log("跳转")
