  ...
  <div class="right_nav_wrap">
    <div class="right_wrap">
      ...
      <div class="nav">
        ...
        <div class="bottom">
          <div class="item" @click="changeLayoutShow('homeContent')">
            <span class="iconfont">&#xe631;</span>
            <p>详情</p>
          </div>
          <div class="item">
            <span class="iconfont" style="font-size: 32px; color: #1FBA75;">&#xe62d;</span>
          </div>
        </div>
      </div>
    </div>
...
<script>
import KaoqinRight from '../components/park/KaoqinRight'
