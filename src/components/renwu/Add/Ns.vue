<!--农事任务添加与修改-->
<template>
  <div id="ElementWind" class="renwu_drag_wrap"  :class="windowStatus == 'small' ? 'renwu_ns_drag_wrap_small' : 'renwu_ns_drag_wrap_big'">
    ...
    <div class="renwu_drag_body" :class="windowStatus == 'small' ? 'renwu_ns_drag_body_small' : 'renwu_ns_drag_body_big'">
      <div class="name_wrap">
...
<script>
  ...
  import TableNs from './Ns/TableNs'
  ...
  export default {
    ...
    methods:{
      ...
      getLeftInfo(val) {
        ...
        this.form.data.after = val.after;
...
<style lang="stylus" scoped>
  ...
  .renwu_ns_drag_wrap_small
    width 900px
    position fixed
    left 50%
    top 50%
    transform translate(-50%, -50%)
  .renwu_ns_drag_wrap_big
    width 100%
    height 100vh
    position fixed
    left 0 !important
  ...
  .renwu_drag_wrap
    ...
    .renwu_ns_drag_body_small
      width 900px
      height 80vh
      overflow-y scroll
    .renwu_ns_drag_body_big
      width 100%
